      ...
      >
        ...
        <div
          className={cn(
            ...
            /* 그에 맞춰 높이도 동적으로 계산 */
            "h-[calc(100dvh_-_var(--header-offset))]",
          ...
          style={
            {
              // top: 72, // 헤더 높이만큼 offset (예: 72px)
              // height: "calc(100vh - 72px)", // 헤더 높이만큼 보정
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium/70 outline-none ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
